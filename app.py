...
if database_uri:
    # Normalize to psycopg v3 driver regardless of the incoming prefix
...
class Survey(db.Model):
    ...
    candy = db.Column(db.String(200))
    salty = db.Column(db.String(200))
    baked = db.Column(db.String(200))
    fastfood = db.Column(db.String(300))
    movie = db.Column(db.String(300))
    book = db.Column(db.String(300))
    shop = db.Column(db.String(300))
    team = db.Column(db.String(300))
